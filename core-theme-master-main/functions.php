 ...
 */
	...
	require_once dirname( __FILE__ ) . '/includes/media-mentions-cpt.php'; // Custom Post Type Case Results
	...
	function postali_child() {
		...
		wp_enqueue_style( 'child-styles', get_template_directory_uri() . '/style.css' ); // Enqueue Child theme style sheet (theme info)
		wp_enqueue_style( 'styles', get_template_directory_uri() . '/assets/css/styles.css'); // Enqueue child theme styles.css
		...
		if ( is_page_template( 'front-page.php' ) ) {
            ...
            wp_register_script('lity', get_template_directory_uri() . '/assets/js/lity.js',array('jquery'), null, true); 
	...
	function mainmenu_navsearch($items, $args) {
		if ($args->theme_location == 'header-nav') {
			...
			<li class="menu-item menu-item-search search-holder">
				<form class="navbar-form-search" role="search" method="get" action="/" title="search bar">
