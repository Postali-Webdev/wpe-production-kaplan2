...
<style type="text/css">  
    ...
    header #header-top #header-top_right #header-top_right_menu .menu li .sub-menu { background: white !important; }
    header #header-top #header-top_right #header-top_right_menu .menu li .sub-menu li a { color: #238E6F !important; }
    header #header-top #header-top_right #header-top_right_menu .menu li .sub-menu li a:hover { background: #238E6F !important; color:white !important; }
    ...
    @media screen and (max-width:1024px) {
        ...
        header #header-top_right_menu #menu-main-menu { background: #fff; }
        header #header-top_right_menu #menu-main-menu.opened::before { background-color: rgba(37,57,60,.9); }
        header #header-top_right_menu #menu-main-menu li .accordion-toggle span { color: white; }
        header #header-top #header-top_right #header-top_right_menu .menu li .sub-menu { background: #fff !important; }
    ...
    .body-container p a { font-family: <?php echo $GLOBALS['font_paragraph']; ?> !important; }
    .body-container h1 { font-family: <?php echo $GLOBALS['font_H1']; ?>; color:<?php echo $body_font_color; ?>; }
    ...
    .banner h1 { font-family: <?php echo $GLOBALS['font_H1']; ?>; color:<?php echo $color_banner_fonts; ?> !important; }
    ...
    /* sidebar */
    .sidebar-block .testimonial-block { background:#F2F2F2 !important; }
