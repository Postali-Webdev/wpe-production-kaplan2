        ...
        <div class="container">
            <div class="columns">
                ...
                <div class="column-25 block">
                    ...
                    <a href="https://kaplanemploymentlaw.cliogrow.com/intake/24aa02f91867242b52f1d5aa9e6cceb9" class="btn" target="blank">Get Started</a>
                </div>
                <div class="column-50 address-map">
                    <div class="footer-address">
                        <p><strong>Office</strong><br>
                            <?php the_field('address','options'); ?><br>
                            <a href="<?php the_field('driving_directions','options'); ?>" title="Driving directions" target="blank">Directions</a><br>
                            <p><a href="tel:<?php the_field('phone_number', 'options'); ?>"><?php the_field('phone_number', 'options'); ?></a></p>
                        </p>
                    </div>
                    <div class="footer-map">
                        <iframe title="google maps kaplan employment law" src="<?php the_field('map_embed','options'); ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
...
<script type="text/javascript" src="//cdn.callrail.com/companies/399550494/863b83afb6be8c131eb8/12/swap.js"></script>  
